...
- [ ] Implement Unit Testing (I think that swagger was enough to provide test cases since no utilities usage just straight if-else and database interaction, correct me if I'm wrong, this will be much more necessary for algorithms test)
